...
export default async function Home() {
  ...
  const response = await fetch("https://api.github.com/users/Wallace143900")
  ...
  return (
      <main className={styles.main}>
        ...
        <div>
          <Link href="/search-users"><button className="btn--green">Encontrar usuário</button></Link>
          <div className={styles["container-projects"]}>
            {dataRepos.slice(0, 8).map((repo) => (
