  ...
  return (
      <main className={styles.main}>
        <div className={styles.mainSearch}>
          <input type="text" placeholder="Nome de usuário" value={searchInput} onChange={(event) => setSearchInput(event.target.value)}/>
        ...
        <div className={styles["main--body"]}>
          {loading ? (
            ...
            <div className="notFound">
              <Image src={notFoundImage} alt="" width={400} height={439} />
